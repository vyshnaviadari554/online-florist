...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. surendranagar">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="e.g. gujrat">
            </div>
            <div class="inputBox">
                <span>country :</span>
            ...
            <div class="inputBox">
                <span>pin code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 363001">
            </div>
        </div>
